            ...
            for i in range(15):
                for j in range(15):
                    ...
                    if (j)*256+640<=4096:
                        ...
                        d = 4096-640
                    cv2.imwrite(outputfolder + f"/sat_{counter_out}_{i}_{j}.jpg", sat[d:d+640,l:l+640])
                    cv2.imwrite(outputfolder + f"/regionmask_{counter_out}_{i}_{j}.jpg", mask[d:d+640,l:l+640])
                    cv2.imwrite(outputfolder + f"/lane_{counter_out}_{i}_{j}.jpg", lane[d:d+640,l:l+640])
                    cv2.imwrite(outputfolder + f"/normal_{counter_out}_{i}_{j}.jpg", normal[d:d+640,l:l+640])
