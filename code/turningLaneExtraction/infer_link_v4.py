...
from model_valid import LinkModel as LinkModel_valid
...
modelpath="../turningLaneValidation/model_turningLaneValidation_run1_640_resnet34_500epseg/model220800"
gpu_options = tf.GPUOptions(allow_growth=True)
sess = tf.Session(config=tf.ConfigProto(gpu_options=gpu_options))
model = LinkModel_valid(sess, 640, batchsize=batchsize)
